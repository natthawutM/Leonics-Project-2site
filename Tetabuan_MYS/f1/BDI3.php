          ...
          <table width="100%" border="0">
            ...
            <tr>
             ...
             <tr>
              ...
              <td spry:region="Plant" class="style_blue">{BDI1_BDI_Heat_Sink_Temp}
                </th>
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" class="style_black">Today Inverter supply Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI1_BDI_Today_Supply_AC_kWh}</td>
              <td class="style_black">kWh</td>
            </tr>
             <tr>
              <td colspan="3" class="style_black">Todate Inverter supply Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI1_BDI_Todate_Supply_AC_kWh}</td>
              <td class="style_black">kWh</td>
            </tr>
             <tr>
              <td colspan="3" class="style_black">Today Inverter charge Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI1_BDI_Today_AC_Chg_kWh}</td>
              <td class="style_black">kWh</td>
            </tr>
            <tr>
              <td colspan="3" class="style_black">Todate Inverter charge Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI1_BDI_Todate_AC_Chg_kWh}</td>
              <td class="style_black">kWh</td>
            </tr> 
          </table>
 </div>
 <div id="d2" style="overflow-x:auto;">
          <table width="100%" border="0">
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" class="style_black">Head Sink Temperature</td>
              <td spry:region="Plant" class="style_blue">{BDI2_BDI_Heat_Sink_Temp}
                </th>
              <td class="style_black">°C</td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" class="style_black">Today Inverter charge Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI2_BDI_Today_AC_Chg_kWh}</td>
              <td class="style_black">kWh</td>
            </tr>
            <tr>
              <td colspan="3" class="style_black">Todate Inverter charge Energy</td>
              <td spry:region="Plant" class="style_blue">{BDI2_BDI_Todate_AC_Chg_kWh}</td>
              <td class="style_black">kWh</td>
            </tr>
          </table>
