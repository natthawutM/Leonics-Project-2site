...
"stage": {
    ...
    content: {
            dom: [
            {
                ...
                fill: ["rgba(0,0,0,0)",'image/main_tetabuan.png','0px','0px']
            },
			{
                id: 'G_irr',
                type: 'rect',
            ...
            },
			{
                id: 'G_load',
                type: 'rect',
                rect: ['852px', '180px','229px','70px','auto', 'auto'],
                opacity: 1,
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            },
            ...
            },
			{
                id: 'GCI_1',
                type: 'text',
                rect: ['573px', '139px','40px','auto','auto', 'auto'],
                text: "DG-1",
            ...
            },
            {
                id: 'GCI_2',
                type: 'text',
                rect: ['613px', '139px','40px','auto','auto', 'auto'],
                text: "DG-2",
                align: "center",
                font: ['Calibri', [0.8, "em"], "rgba(0,0,0,1)", "100", "none", ""]
            },
            ...
            },
			{
                id: 'PV2',
                type: 'rect',
                rect: ['658', '180','auto','auto','auto', 'auto']
            },
			{
                id: 'solar1',
                type: 'rect',
