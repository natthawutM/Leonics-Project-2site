...
$link1 = connectToDB1();
	$strSQL = "SELECT DatetimeLocal,Gen_kW FROM graph where  year(DatetimeLocal)= $y_1 and month(DatetimeLocal)= $m_1 and day(DatetimeLocal)= $d_1    order by DatetimeLocal ASC";
			...
			while($objResult = mysql_fetch_array($objQuery))
			{
				...
				if($objResult['Gen_kW']==-0.999||($objResult['Gen_kW']==NULL)){$Input_V1=0;}else{$Input_V1=$objResult['Gen_kW'];}
...
//Highcharts.chart('container', {
    ...
    tooltip: {
        ...
        pointFormat: '<span style="font-family:Courier; color:transparent; font-size: 8px;">&nbsp;&nbsp;</span>{point.y:,.2f} kW  ',
        shared: false,
	style: {
			fontFamily: 'Calibri',
			color: '#000',
...
//alert("vvv");
		xmlDoc=loadXMLDoc("../xml/Xml_Gen.php");
		var Y=new Number();
