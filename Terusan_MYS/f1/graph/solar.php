...
$link1 = connectToDB1();
	$strSQL = "SELECT DatetimeLocal,SCC_Sum_Chg_kW FROM graph where  year(DatetimeLocal)= $y_1 and month(DatetimeLocal)= $m_1 and day(DatetimeLocal)= $d_1 order by DatetimeLocal ASC";
			...
			while($objResult = mysql_fetch_array($objQuery))
			{
				...
				if($objResult['SCC_Sum_Chg_kW']==-0.999||($objResult['SCC_Sum_Chg_kW']==NULL)){$Input_V1=0;}else{$Input_V1=$objResult['SCC_Sum_Chg_kW'];}
...
//alert("vvv");
		xmlDoc=loadXMLDoc("../xml/Xml_solar.php");
		var Y=new Number();
