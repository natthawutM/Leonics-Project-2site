...
<style>
/* ============================================================
   Solar Monitor Design System — index.php (app shell)
...
<script>
  // ก่อนซ่อน URL เราต้องกำหนด <base> ให้เป็น URL เดิมก่อน เพื่อไม่ให้ลิงก์ย่อยพัง (Cannot GET)
  if (window.history && window.history.replaceState) {
      var base = document.createElement('base');
      base.href = window.location.href.split('#')[0];
      document.head.appendChild(base);

      // ซ่อน Path ทั้งหมดให้เหลือแค่โดเมน และ #
      window.history.replaceState({}, document.title, "/#");
  }
</script>
</head>
